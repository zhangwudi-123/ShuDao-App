...
const Rightfirst = forwardRef(({high, wide }, ref) => {
  ...
  return (
    <>
      ...
      ></ReactECharts>
      <div
        className={stylemodule.rightfirstphoto2}
        style={{
          position: 'relative',
          width: wide,
          height: high *0.45,
      ...
      >
        <div
          className={stylemodule.rightfirstphotodiv2}
          style={{
            position: 'absolute',
            margin: 'auto',
            top: 0,
        ...
        >
          <div 
          className={stylemodule.rightthirdphotodivsum2}
          style={{
            position: 'absolute',
            margin: 'auto',
            top: 0,
          ...
          >
            <span
              className={stylemodule.rightthirdphotodivsumfirst3}
              style={{
                fontSize: wide / 40,
                margin: 'auto',
              }}
