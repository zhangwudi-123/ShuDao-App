...
const SemiFinishedWarehousing1 = ({ f7router }) => {
  ...
  const handleBinding = async ()=>{
    f7router.navigate('/semi-warehousing-binding1', {
    });
  }
  ...
  const handlePickTray =()=>{
    f7router.navigate('/semi-warehousing-pickTray1', {
    });
  }
...
export default SemiFinishedWarehousing1;